...
public class ARFFConverter {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length >= 4){
			...
			ArrayList<String> clases = new ArrayList<String>(); //Array en el que se guardarán las clases

			//Arrays en los que se guardarán los datos
			...
			case "-csv":
				if (args.length == 6){
					...
					System.out.println("Parámetros incorrectos, ejemplos:\n"
